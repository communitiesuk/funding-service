...
Create Date: 2025-05-19 11:32:26.649478
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['collection_schema_id'], ['collection_schema.id'], name=op.f('fk_submission_collection_schema_id_collection_schema')),
    ...
    sa.ForeignKeyConstraint(['form_id'], ['form.id'], name=op.f('fk_question_group_form_id_form')),
    ...
    sa.Column('data_type', sa.Enum('TEXT', 'EMAIL', 'PHONE_NUMBER', 'NUMBER', 'ADDRESS', 'URL', name='datatype'), nullable=False),
    sa.Column('order', sa.Integer(), nullable=False),
    sa.Column('form_id', sa.Uuid(), nullable=False),
    ...
    sa.Column('type', sa.Enum('ANSWER_EQUALS', 'ANSWER_NOT_EQUALS', name='conditiontype'), nullable=True),
    sa.Column('description', sa.String(), nullable=False),
    sa.Column('context', sa.String(), nullable=True),
    sa.Column('depends_on_question_id', sa.Uuid(), nullable=False),
    sa.Column('question_id', sa.Uuid(), nullable=False),
    sa.ForeignKeyConstraint(['depends_on_question_id'], ['question.id'], name=op.f('fk_condition_depends_on_question_id_question')),
