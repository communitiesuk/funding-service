...
Create Date: 2025-05-13 10:57:54.675249
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("type", sa.Enum("QUESTION", "INFORMATION", "GROUP", name="questiontype"), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["parent_question_id"], ["question.id"], name=op.f("fk_question_parent_question_id_question")
        ),
