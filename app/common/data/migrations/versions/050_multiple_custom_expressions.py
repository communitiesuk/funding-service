...
Revises: 049_add_custom_expressions
...
down_revision = "049_add_custom_expressions"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index(
        ...
        unique=True,
        postgresql_where=(
            "type = 'VALIDATION'::expression_type_enum AND managed_name IS NOT NULL "
            "AND managed_name != 'CUSTOM'::managed_expression_enum"
        ),
    )
    ...
    op.create_index(
        ...
        unique=True,
        postgresql_where=(
            "type = 'CONDITION'::expression_type_enum AND managed_name IS NOT NULL "
            "AND managed_name != 'CUSTOM'::managed_expression_enum"
        ),
    )
