...
class CollectionStatusEnum(enum.StrEnum):
    ...
    def __lt__(self, other: CollectionStatusEnum) -> bool:  # ty: ignore[invalid-method-override]
    ...
    def __gt__(self, other: CollectionStatusEnum) -> bool:  # ty: ignore[invalid-method-override]
        if not isinstance(other, CollectionStatusEnum):
            return NotImplemented
        ordered_list_of_names = CollectionStatusEnum._member_names_
        return ordered_list_of_names.index(self.name) > ordered_list_of_names.index(other.name)
...
class QuestionOptionsPostgresType(TypeDecorator):
    ...
    def process_bind_param(self, value: BaseModel, dialect: Any) -> Any:  # ty: ignore[invalid-method-override]
        if value is None:
            return None
...
class DataSourceFileMetadataPostgresType(TypeDecorator):
    ...
    def process_bind_param(self, value: DataSourceFileMetadata, dialect: Any) -> dict[str, str] | None:  # ty: ignore[invalid-method-override]
        if value is None:
            return None
        return value.model_dump(mode="json", exclude_none=True)
...
class DataSourceSchemaPostgresType(TypeDecorator):
    ...
    def process_bind_param(self, value: DataSourceSchema, dialect: Any) -> dict[str, dict[str, Any]] | None:  # ty: ignore[invalid-method-override]
        if value is None:
            return None
        return value.model_dump(mode="json", exclude_none=True)
