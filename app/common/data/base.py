...
from app.common.data.types import QuestionOptions, QuestionOptionsPostgresType, json_flat_scalars, json_scalars
...
class BaseModel(DeclarativeBase):
    ...
    type_annotation_map = {
        ...
        QuestionOptions: QuestionOptionsPostgresType,
        CIStr: CITEXT,
    }
