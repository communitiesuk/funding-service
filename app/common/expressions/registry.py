...
def get_supported_form_questions(component: "Component") -> list["Question"]:
    questions = component.form.questions
    return [q for q in questions if q.data_type in get_registered_data_types() and q.id != component.id]
