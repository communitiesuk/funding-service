...
TManagedExpression = TypeVar("TManagedExpression", bound="ManagedExpression")
...
def register_managed_expression(cls: type[TManagedExpression]) -> type[TManagedExpression]:
    """
