...
from typing import TYPE_CHECKING, Any, Callable, NamedTuple, Sequence, cast
...
class SubmissionHelper:
    ...
    @cached_property
    def resolver(self) -> VisibilityResolver:
        ...
        for question in form.cached_questions:
            ...
            if question.add_another_container:
                ...
                if number_of_add_another_entries == 0:
                    ...
                    if self.resolver.is_visible(question):
                    ...
                    for i in range(number_of_add_another_entries):
                        if self.resolver.is_visible(question, add_another_index=i):
                ...
                if depends_on.form_id != form.id:
                    if depends_on.is_question:
                        ...
                        if answer is None:
                            ...
                            visibility = self.resolver.get_visibility(depends_on.id)
    ...
    def _get_ordered_visible_questions(
        ...
        *,
        ...
        return [
            ...
            if self.resolver.is_visible(question, add_another_index=add_another_index)
        ]
            ...
            for question, header_string, index in question_headers:
                if not question.add_another_container:
                    ...
                    if submission.get_count_for_add_another(question.add_another_container) <= index:
                        ...
                        if submission.resolver.is_visible(question, add_another_index=index):
