...
class SubmissionHelper:
    ...
    def submit(self, user: "User") -> None:
        ...
        users_needing_confirmation = set(
            self.submission.grant_recipient.data_providers + list(self.submission.grant_recipient.certifiers)
        )
    ...
    def mark_as_sent_for_certification(self, user: "User") -> None:
        ...
        if self.all_forms_are_completed:
            ...
            # TODO do we need this once the test grant recipient stuff is merged? Likely yes as preview submissions
            #  will still not have a GR, but one to validate
