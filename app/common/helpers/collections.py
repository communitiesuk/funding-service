...
class SubmissionHelper:
    ...
    def get_status_for_form(self, form: "Form") -> TasklistSectionStatusEnum:
        ...
        marked_as_complete = SubmissionEventType.FORM_RUNNER_FORM_COMPLETED in [
            x.event_type for x in self.ordered_events if x.target_key == form.id
        ]
    ...
    def toggle_form_completed(self, form: "Form", user: "User", is_complete: bool) -> None:
        ...
        if is_complete:
            ...
            interfaces.collections.clear_submission_events(
                self.submission, event_type=SubmissionEventType.FORM_RUNNER_FORM_COMPLETED, target_key=form.id
            )
