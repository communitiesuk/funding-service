...
(function (window) {
    ...
    window.MHCLG.FSModules.GenerateQuestionName = function () {
        ...
        const makeApiCall = async (inputValue, targetElement, component, outputElement) => {
            ...
            if (formId) {
                ...
                if (form) {
                    ...
                    console.log('Collected form data from form:', formId);
                } else {
            ...
            try {
                ...
                console.log('Question name generated successfully:', data);
        ...
        this.start = function (component) {
            console.log('Starting GenerateQuestionName module on', component);
        ...
        // Optional: Method to manually trigger API call
        this.generateQuestionName = function(inputElement, component) {
            if (inputElement && inputElement.value && component) {
                clearTimeout(debounceTimer);
                const outputElement = document.getElementById(
                    component.dataset.fsModuleTargetOutputId
                );
                ...
                makeApiCall(inputElement.value, inputElement, component, outputElement);
            }
        };
    };
})(window);
