...
class _SharedConfig(_BaseConfig):
    ...
    GOVUK_NOTIFY_ACCESS_CONFIRM_PUBLIC_SIGN_UP_TEMPLATE_ID: str = "bede86cd-b956-4dad-8f28-17a797788811"
    GOVUK_NOTIFY_ACCESS_TEAM_MEMBER_INVITATION_TEMP_DELIVERY_FAILURE_ID: str = "8b7ad73b-e828-452a-9961-94c551c3dcbf"
    GOVUK_NOTIFY_ACCESS_TEAM_MEMBER_INVITATION_PERM_DELIVERY_FAILURE_ID: str = "f7ca8e85-f336-45c5-9295-23643c6167a5"
