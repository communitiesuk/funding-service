...
class CreateCustomExpressionPage(ReportsBasePage):
    ...
    def __init__(self, page: Page, domain: str, grant_name: str, report_name: str, section_name: str) -> None:
        super().__init__(
            ...
            domain,
            grant_name=grant_name,
            heading=page.get_by_role("heading", name="Add a custom validation expression"),
        )
        self.report_name = report_name
        self.section_name = section_name
        self.add_validation_button = self.page.get_by_role("button", name="Add validation")

        self.custom_expression_textarea = get_context_aware_textbox_locator_by_name(page, "Expression")
...
class AddValidationPage(ReportsBasePage):
    ...
    def click_create_custom_expression(self) -> "CreateCustomExpressionPage":
        self.page.get_by_role("button", name="Create a custom expression").click()
