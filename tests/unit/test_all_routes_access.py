...
routes_with_expected_grant_admin_only_access = [
    ...
    "deliver_grant_funding.collection_configure_validate_submission",
    "deliver_grant_funding.collection_configure_rolling_submissions",
...
routes_with_expected_member_only_access = [
    ...
    "deliver_grant_funding.validate_submission",
    "deliver_grant_funding.revise_assessment_decision",
...
routes_with_no_expected_access_restrictions = [
    ...
    "access_grant_funding.public_sign_up_name",
    "access_grant_funding.public_sign_up_organisation_type",
    "access_grant_funding.public_sign_up_organisation_reference",
    "access_grant_funding.public_sign_up_organisation_name",
    "access_grant_funding.public_sign_up_confirm_organisation",
    "access_grant_funding.public_sign_up_check_your_answers",
    "access_grant_funding.public_sign_up_contact_support",
    "static",
