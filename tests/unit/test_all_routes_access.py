...
routes_with_expected_grant_admin_only_access = [
    ...
    "deliver_grant_funding.collection_configure_scoring",
...
routes_with_expected_member_only_access = [
    ...
    "deliver_grant_funding.list_recipients",
    ...
    "deliver_grant_funding.request_changes_on_submission",
    "deliver_grant_funding.decline_submission_validation",
...
routes_with_no_expected_access_restrictions = [
    ...
    "access_grant_funding.public_grant_sign_up",
