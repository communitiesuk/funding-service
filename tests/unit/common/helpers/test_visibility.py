...
from app.common.collections.types import IntegerAnswer, TextSingleLineAnswer, YesNoAnswer
    ...
    class TestConditionsOperator:
        ...
        def test_any_condition_visibility(self, factories):
            ...
            submission = factories.submission.build(
                collection=form.collection, answers=[FactoryAnswer(q1, TextSingleLineAnswer("no"))]
            )
            resolver = TestVisibilityResolver._get_resolver(submission)
            ...
            submission = factories.submission.build(
                ...
                answers=[FactoryAnswer(q1, TextSingleLineAnswer("no")), FactoryAnswer(q3, TextSingleLineAnswer("yes"))],
            )
            resolver = TestVisibilityResolver._get_resolver(submission)
            ...
            submission = factories.submission.build(
                collection=form.collection,
                answers=[FactoryAnswer(q1, TextSingleLineAnswer("no")), FactoryAnswer(q3, TextSingleLineAnswer("no"))],
            )
            resolver = TestVisibilityResolver._get_resolver(submission)
            ...
            submission = factories.submission.build(
                collection=form.collection,
                answers=[FactoryAnswer(q1, TextSingleLineAnswer("yes"))],
            )
            resolver = TestVisibilityResolver._get_resolver(submission)
