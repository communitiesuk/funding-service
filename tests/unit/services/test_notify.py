...
from app.services.notify import Notification, NotificationReference, NotificationReferenceType
...
class TestNotificationReference:
    def test_for_invitation(self, factories):
        invitation = factories.invitation.build()

        reference = NotificationReference.for_invitation(invitation)

        assert reference == NotificationReference(type_=NotificationReferenceType.INVITATION, id=invitation.id)
    ...
    def test_from_reference(self):
        ...
        assert reference == NotificationReference(type_=NotificationReferenceType.INVITATION, id=id_)

    def test_from_reference_round_trips(self, factories):
        reference = NotificationReference.for_invitation(factories.invitation.build())
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "db:not_a_kind:11111111-1111-1111-1111-111111111111",
