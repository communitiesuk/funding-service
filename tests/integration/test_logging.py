...
class TestLogging:
    def test_basic_log_message(self, app: Flask, caplog: LogCaptureFixture) -> None:
    ...
    def test_can_log_simple_interpolated_values(self, app: Flask, caplog: LogCaptureFixture, simple: Any) -> None:
        with app.app_context():
    ...
    def test_cannot_log_complex_data_types(self, app: Flask, caplog: LogCaptureFixture, complex: Any) -> None:
