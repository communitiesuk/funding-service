...
class TestLogging:
    def test_basic_log_message(self, app, caplog):
    ...
    def test_can_log_simple_interpolated_values(self, app, caplog, simple):
        with app.app_context():
    ...
    def test_cannot_log_complex_data_types(self, app, caplog, complex):
