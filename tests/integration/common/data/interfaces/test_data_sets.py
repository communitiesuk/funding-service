...
class TestReplaceUploadedDataSource:
    ...
    def test_replace_data_source_updates_column_order(self, factories):
        ...
        replace_uploaded_data_source(
            data_source=data_source,
            new_columns=[DataSetColumnMapping(column_name="New column", column_type="TEXT")],
            all_headers=[
                "Just text",
                "New column",
                "Whole number",
        ...
        assert [column.original_column_name for column in from_db.schema.ordered_values()] == [
            "Just text",
            "New column",
            "Whole number",
            "Decimal number",
