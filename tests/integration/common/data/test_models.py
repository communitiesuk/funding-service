...
class TestQuestionModel:
    def test_question_property_selects_expressions(self, factories):
        ...
        condition_expression = factories.expression.create(question=question, type=ExpressionType.CONDITION)
        validation_expression = factories.expression.create(question=question, type=ExpressionType.VALIDATION)
