...
def delta_test_data(factories, db_session):
    ...
    org_match = factories.organisation.create(external_id="GB-GOV-MATCH", name="Matching Council")
    org_diff = factories.organisation.create(external_id="GB-GOV-DIFF", name="Different Council")
    factories.organisation.create(external_id="GB-GOV-EMPTY", name="Empty Council")
    org_delegated = factories.organisation.create(external_id="GB-GOV-DELEGATED", name="Delegated Council")
    ...
    test_org = factories.organisation.create(
        external_id="GB-GOV-TEST", name="Test Mode Council", mode=OrganisationModeEnum.TEST
    )
...
class TestS3ZipSource:
    def test_s3_uri_downloads_and_unzips_csv(
        ...
        factories.organisation.create(external_id="GB-GOV-DELEGATED", name="Delegated Council")
