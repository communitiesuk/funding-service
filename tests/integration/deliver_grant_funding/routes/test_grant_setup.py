...
class TestGrantSetupIntro:
    def test_grant_setup_intro_get(self, authenticated_platform_admin_client):
    ...
    def test_grant_setup_intro_post(self, authenticated_platform_admin_client):
...
class TestGrantSetupGgis:
    def test_grant_setup_ggis_get_with_session(self, authenticated_platform_admin_client):
    ...
    def test_grant_setup_ggis_get_without_session_redirects(self, authenticated_platform_admin_client):
        response = authenticated_platform_admin_client.get(url_for("deliver_grant_funding.grant_setup_ggis"))
        assert response.status_code == 302
        assert response.location == url_for("deliver_grant_funding.grant_setup_intro")

    def test_grant_setup_ggis_post_with_ggis(self, authenticated_platform_admin_client):
        # Set up session state first
        with authenticated_platform_admin_client.session_transaction() as sess:
            sess["grant_setup"] = {}
    ...
    def test_grant_setup_ggis_post_no_ggis_redirects_to_required_info(self, authenticated_platform_admin_client):
        # Set up session state first
        with authenticated_platform_admin_client.session_transaction() as sess:
            sess["grant_setup"] = {}
    ...
    def test_grant_setup_ggis_required_info_get(self, authenticated_platform_admin_client):
        response = authenticated_platform_admin_client.get(
            url_for("deliver_grant_funding.grant_setup_ggis_required_info")
        )
        assert response.status_code == 200
        soup = BeautifulSoup(response.data, "html.parser")
...
class TestGrantSetupName:
    def test_grant_setup_name_get_with_session(self, authenticated_platform_admin_client):
        with authenticated_platform_admin_client.session_transaction() as sess:
            sess["grant_setup"] = {}
    ...
    def test_grant_setup_name_post(self, authenticated_platform_admin_client):
        with authenticated_platform_admin_client.session_transaction() as sess:
            sess["grant_setup"] = {}
...
class TestGrantSetupDescription:
    def test_grant_setup_description_get_with_session(self, authenticated_platform_admin_client):
        with authenticated_platform_admin_client.session_transaction() as sess:
            sess["grant_setup"] = {}
    ...
    def test_grant_setup_description_post_too_long(self, authenticated_platform_admin_client):
        with authenticated_platform_admin_client.session_transaction() as sess:
            sess["grant_setup"] = {}
    ...
    def test_grant_setup_description_post_valid(self, authenticated_platform_admin_client):
        with authenticated_platform_admin_client.session_transaction() as sess:
            sess["grant_setup"] = {}
...
class TestGrantSetupContact:
    def test_grant_setup_contact_get_with_session(self, authenticated_platform_admin_client):
        with authenticated_platform_admin_client.session_transaction() as sess:
            sess["grant_setup"] = {}
    ...
    def test_grant_setup_contact_post_valid(self, authenticated_platform_admin_client):
...
class TestGrantSetupCheckYourAnswers:
    def test_grant_check_your_answers_post_creates_grant(self, authenticated_platform_admin_client, db_session):
        # Set up session with required data for grant creation
        with authenticated_platform_admin_client.session_transaction() as sess:
            sess["grant_setup"] = {
                "name": "Test Grant",
